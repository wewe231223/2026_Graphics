...
namespace Game::IK {
    ...
    bool TryAlignFootToSurface(Arche::World& World, Arche::EntityID FootEntityId, Arche::EntityID ToeEntityId, const DirectX::SimpleMath::Vector3& RayOppositeDirection, const DirectX::SimpleMath::Vector3& SurfaceNormal, float AlignmentWeight, ::std::unordered_map<Arche::EntityID, DirectX::SimpleMath::Matrix>& InOutWorldMatrices);
